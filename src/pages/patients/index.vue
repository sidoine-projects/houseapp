              ...
              <table id="order-listing" ref="myTable" class="table table-bordered">
                ...
                <tbody>
                  <tr v-for="(patient, index) in patients" :key="patient.id">
                    <td>{{ index + 1 }}</td>
                    <td style="text-transform: uppercase">{{ patient.nom }}</td>
                    ...
                    <td class="text-center">
                      ...
                      <b-button @click="update(patient.id)" size="sm" v-b-tooltip.hover title="Modifier"
                        variant="warning">
...
export default {
  ...
  methods: {
    ...
    supprimer(index) {
      ...
      this.deleteName = this.patients[index].nom + ' ' + this.patients[index].prenom;
