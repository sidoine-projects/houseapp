      ...
      <nav aria-label="breadcrumb">
        <ul class="breadcrumb">
          <li class="breadcrumb-item active" aria-current="page">
            <span></span>Overview
            <i
              class="mdi mdi-view-dashboard-outline icon-sm text-success align-middle"
            ></i>
          </li>
        </ul>
      </nav>
          ...
          <div class="card-body">
            <div class="clearfix">
              <h4 class="card-title float-left">
                Evolution annuelle des encaissements et decaissements
              ...
              >
                <ul>
                  <li>
                    <span class="legend-dots bg-gradient-success"></span
                    >Encaissement
                  </li>
                  <li>
                    <span class="legend-dots bg-gradient-danger"></span
                    >Décaissement
                  </li>
                  <!-- <li>
      ...
      <div class="col-lg-4 grid-margin stretch-card">
        <div class="card">
          ...
          <date-picker
            ...
            class="datepicker datepicker-custom vue-datepicker-body vue-datepicker-current"
            v-model="time1"
            valueType="format"
            inline
            style="border-radius: 50% !important; background-color: #007aff"
          ></date-picker>
