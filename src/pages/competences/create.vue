        ...
        <div class="card">
          <div class="">
            <div
              ...
              <h6 class="mb-0 text-info">AJOUTER UNE CONNAISSANCE</h6>
              <!-- Texte du h4 -->
              <button class="btn btn-secondary">
                <router-link to="/competences/list"> RETOUR </router-link>
              </button>
              <!-- Bouton Retour -->
            </div>
            <hr class="row" />
            ...
            <form class="forms-sample card-body mt-n2" @submit.prevent="store">
              <div class="col-md-12">
                <div class="row">
                  ...
                  <div class="form-group controls col-md-4">
                    <label for="exampleFormControlSelect1"
                      >Niveau<span class="font-weight-bold" style="color: red">
                        *</span
                      ></label
                    >
                    <select
