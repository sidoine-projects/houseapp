              ...
              >
                ...
                <tbody>
                  <tr v-for="(form, index) in forms" :key="index">
                    ...
                    <!-- <td>{{ form.agemin }}</td>
                    <td>{{ form.agemax }}</td> -->
                    <td>{{ "[" + form.agemin + " - " + form.agemax + "]" }}</td>
                    <td>{{ form.pourcentage }}</td>
...
export default {
  ...
  mounted() {
    ...
    indigenceService.getAllIndigences().then((res) => {
  ...
  methods: {
    ...
    // },
    update(id) {
      this.$router.push("/indigence/update/" + id);
    },

    supprimer(index) {
      this.deleteIndex = index;
      // this.deleteName = this.forms[index].agemin;
      this.deleteName =
        "[" + this.forms[index].agemin + " - " + this.forms[index].agemax + "]";
    ...
    confirmDelete() {
      ...
      if (index !== null) {
        indigenceService
          .deleteIndigence(this.forms[index].id)
          .then((res) => {
            this.forms.splice(index, 1);
            console.log(res);
            // Afficher le toast de succès
            this.$toast.success("Indigence supprimée avec succès !", {
