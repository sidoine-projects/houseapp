              ...
              <table id="order-listing" ref="myTable" class="table table-bordered">
                ...
                <tbody>
                  <tr v-for="(priseencharge, index) in priseencharges" :key="priseencharge.id">
                    ...
                    <td> {{ new Date(priseencharge.datedebut ).toLocaleDateString('fr-FR', { day: 'numeric', month: 'numeric', year: 'numeric' }) }}</td>
                    <td> {{ new Date(priseencharge.datefin ).toLocaleDateString('fr-FR', { day: 'numeric', month: 'numeric', year: 'numeric' }) }}</td>
