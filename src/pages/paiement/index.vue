          ...
          <div class="modal-body" id="print-section" ref="modalContent">
            ...
            <div class="container-fluid">
              <div class="row mb-2 mr-0 ml-0 col-sm-12">
                ...
                <div class="col-sm-4 text-center mt-auto mx-auto">
                  ...
                  <tfoot>
                    ...
                    <tr v-if="mode_payement_id == 3">
                      ...
                      <!-- <td><strong>{{ formatNumber(((calculerMontantTotal() - totalPriseEncharge) * 2.9) / 100) }}
                          FCFA</strong></td> -->
                      <td><strong>{{ formatNumber((montantPaye - (calculerMontantTotal() - totalPriseEncharge))) }}
                          FCFA</strong></td>
                    </tr>


                    <tr v-if="mode_payement_id == 4">
                    ...
                    <!-- <tr v-if="mode_payement_id == 4">
                      ...
                      <td colspan="5" class="text-right"><strong> kkiapay(+1,9 %)</strong></td>
                      <td><strong>{{ formatNumber(( montantPaye -(calculerMontantTotal() - totalPriseEncharge) ) ) }}
                          FCFA</strong></td>
                    </tr> -->
                    <tr>
              ...
              <div class="row mt-1">
                <div class="col-sm-6">
                  ...
                  <div>
                    <router-link v-if="qrCodeUrl"
                      :to="{ name: 'FactureDetails', params: { id: payement_id }, path: '/facture' + $route.path }"
                      target="_blank">
...
export default {
  ...
  methods: {
    ...
    //   const invoiceDetailsUrl = `/facture/details/${payementId}`;
    ...
    //   QRCode.toDataURL(invoiceDetailsUrl)
    //     .then((dataURL) => {
