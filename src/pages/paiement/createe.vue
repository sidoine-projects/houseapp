          ...
          <div class="card-body">
            ...
            <form class="forms-sample p-2">
                ...
                <fieldset class="scheduler-border col-md-12"
                  ...
                  <div class="row" v-if="assurancePourcentage !== null">
                    ...
                    <div class="form-group p-2 col-md-3">
                      ...
                      <div class=" form-group p-2 col-md-3">
                        <label for="exampleInputUsername1">
                          Numéro Assurance</label>
                        <input readonly type="text" class="form-control" id="exampleInputUsername1"
                          placeholder="Numéro Assurance" v-model="assuranceNumero" />
                      </div>
                  </div>
              ...
              <fieldset class="scheduler-border container-fluid col-md-12">
                ...
                <div class="control-group mt-2 p-2" id="app">
                  <div class="row" v-for="(form, index) in forms" :key="index">
                    ...
                    <div v-if="form.acte === '0'" class="col-md-8 mb-2">
                      ...
                      <input type="text" class="form-control" id="" placeholder="Autre" v-model="form.autre" />
                    </div>
                    ...
                    <div class="form-group" :class="form.acte === '0' ? 'col-md-4 mb-2' : 'col-md-2 mb-2'">
                      ...
                      <input type="number" :min="1" class="form-control" id="exampleInputUsername1"
                        @input="updateMontantActe(index)" placeholder="Quantité" v-model="form.quantite" />
                    </div>
                    <div class="form-group" :class="form.acte === '0' ? 'col-md-4 mb-2' : 'col-md-2 mb-2'">
                ...
                <div class="form-group">
                  <input readonly type="text" class="form-control text-right pr-5" id="" placeholder="Montant" :value="'Total Montant :    ' + calculateTotalMontantActe() + '   FCFA'
                ...
                <div class="form-group" style="text-align: right !important">
                  ...
                  <input readonly type="text" class="form-control font-weight-bold" id="exampleInputUsername1"
                    v-model="momoDataEspece.montant" placeholder="Montant total" style="text-align: right !important" />
                </div>
                ...
                <div class="control-group col-md-12">
                  ...
                  <!-- <div class="form-group col-lg-6 col-sm-12 text-center">
                    <button id="pay-btn" style="top: 20px; font-size: 17px;" type="button"
                      class="btn btn-success btn btn-right col-md-8" @click="fedaPay">
                      <span class="text-center ml-1">Fedapay</span>
                    </button>
                  </div>  -->
                </div>
...
<!-- 
                          <div>
                            ...
                            <a :href="invoiceUrl">Détails de la facture</a>
                          </div> -->
...
export default {
  ...
  methods: {
    ...
    fedaPay(payementId) {
      return FedaPay.init("#pay-btn", {
        public_key: "pk_sandbox_akg8GMJCWkTGOGhSEZ6olRFb",
        transaction: {
          // amount: '20000',
          amount: this.momoData.montant,
    ...
    //     });
    // },
    generateQRCode(idFacture) {

      factureService.getGenerateCodeQR(idFacture)
        .then((res) => {
    ...
    validerMomo(payementId) {
      ...
      if (this.momoData.nom === "") {
        this.formErrors.nom = true;
        return; // Sortir de la fonction en cas d'erreur
      }

      if (this.momoData.prenom === "") {
        this.formErrors.prenom = true;
        return; // Sortir de la fonction en cas d'erreur
      }

      if (this.momoData.telephone === "") {
  ...
  mounted() {
    ...
    //   public_key: 'pk_live_pEpqCZWH8MzLlFG06SCzq3ZU',
    //   transaction: {
    //     amount: 1000,
